 ...
 *
 * It uses SET_CARS mutation to update Catalog state with the latest flights.
 *
 ...
 * @param {string} obj.carMake - Make of the car that the information about is being fetched
 * @param {string} obj.carModel - Model of the car that the information about is being fetched
